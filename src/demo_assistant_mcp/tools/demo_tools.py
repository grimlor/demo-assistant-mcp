...
def load_demo_script(file_path: str) -> Dict[str, Any]:
    ...
    Raises:
        ActionableError: If file not found, invalid format, or no prompts
    """
...
def next_demo_step() -> Dict[str, Any]:
    ...
    Raises:
        ActionableError: If no demo has been loaded
    """
...
def execute_demo_step(prompt_text: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    Raises:
        ActionableError: If no demo has been loaded or no pending prompt
    """
    state = require_loaded_demo()
    ...
    if prompt_text:
        ...
        if not prompt:
            raise ActionableError(
                "No prompt available to execute",
