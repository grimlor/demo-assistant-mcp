...
class DemoState:
    ...
    pending_prompt: Optional[DemoPrompt] = None
    ...
    def get_current_prompt(self) -> Optional[DemoPrompt]:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            } if self.pending_prompt else None
        }
...
def require_loaded_demo() -> DemoState:
    ...
    if not state.is_loaded:
        raise ActionableError.no_demo_loaded("proceed with operation")
    return state
